...
// Asset por defecto: byte-full.png — Byte completo, extraído del arte oficial del banner
// (byte-mascot.png y pixel-bug.png están recortados dentro del archivo; no usarlos sueltos)
export default function ByteMascot({ size = 80, mood = 'default', style = {}, variant = null, className = '', src = '/byte-full.png' }) {
  return (
    <div
